...
@push('css')
    ...
    <link rel="stylesheet" type="" href="https://unpkg.com/@geoman-io/leaflet-geoman-free@latest/dist/leaflet-geoman.css" />
@endpush
@section('content')
                ...
                <div class="card-body">
                    <form action="{{ route('admin-desa-update', $desa->id) }}" id="form-desa" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" class="form-control" name="warna_batas" id="color-picker" value="{{$desa->warna_batas}}">
                        </div>
                        <div class="form-group">
                        ...
                        <span><button type="submit" class="btn btn-primary float-right"><i class="fas fa-window-plus"></i>Update</button></span>
                        <span><button type="button" class="btn btn-secondary float-right mr-2"><i class="fas fa-window-plus"></i>Batal</button></span>
                    </form>
                </div>
            </div>
        </div>
