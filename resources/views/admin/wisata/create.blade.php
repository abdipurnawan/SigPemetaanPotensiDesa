    ...
    <div class="row">
        ...
        <div class="col-md-4 col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('admin-wisata-store') }}" id="form-desa" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        <div class="form-group">
                            <label for="">Nama Tempat Wisata</label>
                            <input type="text" class="form-control @error('nama_tempat_wisata') is-invalid @enderror" name="nama_tempat_wisata" placeholder="Masukkan nama tempat wisata" required>
                        ...
                        <div class="form-group form-group mt-3">
                            ...
                            <select class="form-control @error('nama_sekolah') is-invalid @enderror" data-live-search="true" id="desaa" rows="3" name="desa" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" placeholder="Masukkan alamat tempat wisata" required>
                            @error('alamat')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" rows="5" placeholder="Masukkan deskripsi tempat wisata" required></textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
